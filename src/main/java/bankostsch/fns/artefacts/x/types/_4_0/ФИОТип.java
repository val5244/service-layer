 ...
 *       &lt;attribute name="Фамилия" use="required" type="{urn://x-artefacts-fns-bankostsch/types/4.0.1}string-60" />
 *       &lt;attribute name="Имя" use="required" type="{urn://x-artefacts-fns-bankostsch/types/4.0.1}string-60" />
 *       &lt;attribute name="Отчество" type="{urn://x-artefacts-fns-bankostsch/types/4.0.1}string-60" />
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
 * </pre>
